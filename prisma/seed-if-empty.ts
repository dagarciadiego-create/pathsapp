...
async function main() {
  ...
  const contactEs = await prisma.contact.create({
    data: {
  ...
  const contactEn = await prisma.contact.create({
    data: {
  ...
  const goalEsOutcome = await prisma.advocacyGoal.create({
    data: {
  ...
  await prisma.advocacyGoal.create({
    data: {
  ...
  const goalEnOutcome = await prisma.advocacyGoal.create({
    data: {
